...
declare module Default {
    ...
    export class Default extends $data.EntityContext {
        ...
        Contacts: $data.EntitySet<typeof Default.Contact, Default.Contact>;
        initDb: { (): Promise<void>; };
    }

    export class Contact extends $data.Entity {
        constructor();
        constructor(initData: { _id?: Edm.String; firstName?: Edm.String; lastName?: Edm.String; email?: Edm.String; phoneNumber?: Edm.String });
...
export var type: typeof Default.Default;
export var factory: (config:any) => Default.Default;